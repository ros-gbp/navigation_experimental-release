Name:           ros-melodic-goal-passer
Version:        0.2.0
Release:        0%{?dist}
Summary:        ROS goal_passer package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/goal_passer
...
%description
A global planner plugin for move_base that simply passes the target pose on as a
global plan. Useful for debugging local planners.
